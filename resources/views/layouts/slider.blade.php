<div class="w-full overflow-hidden flex flex-nowrap text-center items-start text-red-900 font-bold" id="slider">
    ...
    <div class="flex-none w-full flex flex-col items-center justify-center">
        <img src="https://picsum.photos/id/306/1000/350" class="object-cover w-full h-full">
        <p class="text-md mt-4 md:text-2xl px-2">
            काथोग नमनङ होसेल छोलिङ गुम्बा
        </p>
    </div>
    <div class="flex-none w-full flex flex-col items-center justify-center">
        <img src="https://picsum.photos/id/631/1000/350" class="object-cover w-full h-full">
